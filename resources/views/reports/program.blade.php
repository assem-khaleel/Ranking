        ...
        <div class="col-md-12 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a
                            href="{{route('report.programShow')}}">{{trans('common.programReports')}}</a></li>
            </ol>
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title m-b-40">{{trans('common.programReports')}}</h4>
                        <form action="{{route('report.programShow')}}" class="form-horizontal"
                              method="get">
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <div class="col-md-3">
                                                <select class="select2 form-control custom-select"
                                                        style="width: 100%; height:36px;" name="program" data-placeholder="{{trans('criterias.selectProgram')}}">
                                                    <option value="">{{trans('criterias.selectProgram')}}</option>
                                                    @foreach($programs as $program)
                                                        <option value="{{$program->id}}" {{old('program') == $program->id || !empty($programCurrent) && $program->id == $programCurrent->id ? 'selected' : '' }}>{{$program->name}}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-2">
                                                <button style="width: 100%; height:34px;" type="submit"
