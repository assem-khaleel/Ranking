                ...
                <div class="card">
                    <div class="card-body">
                        <center class="m-t-30"><img class="img-circle" width="150" src="{{(!empty($user->image->path)) ? asset('storage/'.$user->image->path):'/images/avatar.png'}} ">
                            ...
                            <h6 class="card-subtitle">{{trans('profiles.role')}} : {{$user->systemUser ? trans('profiles.adminSystem') : trans('profiles.null')}}</h6>
                ...
                <div class="card">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="settings" role="tabpanel">
                            <div class="card-body">
                                <form class="form-horizontal form-material"
                                      action="{{route('system-user.update',$user->id)}}" method="post" enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf
                        ...
                        <div class="tab-pane" id="security" role="tabpanel">
                            <div class="card-body">
                                <form class="form-horizontal form-material"
                                      action="{{route('users.changePasswordSystem', ['userId' => $user->id])}}" method="post">
                                    @method('PUT')
                                    @csrf
                                    <div class="form-group">
